...
#SBATCH --chdir /scratch/ldelisle/HoxBstudy/genomes/ # This directory must exists, this is where will be the error and out files
...
basenamePathForB2Index="${PWD}/bowtie2/__genome__"
