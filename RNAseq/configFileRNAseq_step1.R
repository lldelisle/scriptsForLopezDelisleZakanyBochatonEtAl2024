...
outputFolderForStep1 <- "/scratch/ldelisle/HoxBstudy/RNAseq//mergedTables/"
...
# remove some genes.
# initialTableWithCount<-'/home/ldelisle/softwares//rnaseq_rscripts/example/mergedTables/AllHTSeqCounts.txt'
...
genesToRmFromCounts <- "/home/ldelisle/softwares/scriptsForLopezDelisleZakanyBochatonEtAl2024/RNAseq/geneschrM.txt"
# Optional:
mergeFPKM <- T
...
# normalize it.
# initialTableWithFPKM<-'/home/ldelisle/softwares//rnaseq_rscripts/example/mergedTables/AllCufflinks_Simplified.txt'
