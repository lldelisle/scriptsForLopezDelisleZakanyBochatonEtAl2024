...
# 'sample'.
samplesPlan <- "/home/ldelisle/softwares/scriptsForLopezDelisleZakanyBochatonEtAl2024/RNAseq/samplesplan_embryos.txt"

#### STEP 2 - DESEQ 2 ANALYSIS ####
# Required
tableWithCounts <- "/scratch/ldelisle/HoxBstudy/RNAseq//mergedTablesE/AllHTSeqCounts_subset_onlypc.txt"
...
all.analyses <- list(
  "genotype" = list(
      "genotype" = list("stage" = "E9.5"),
      "genotype" = list("stage" = "E10.5"),
      "genotype" = list(
        "genotype" = c("deli9-13", "deli9-13hd"),
        "stage" = "E10.5"
      )
  )
)
...
pathForDESeq2 <- "/scratch/ldelisle/HoxBstudy/RNAseq/DESeq2_multi_E_onlypc/"
