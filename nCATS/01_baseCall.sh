...
~/softwares/ont-guppy-cpu_5.0.16/bin/guppy_basecaller --version
# : Guppy Basecalling Software, (C) Oxford Nanopore Technologies, Limited. Version 5.0.16+b9fcd7b
~/softwares/ont-guppy-cpu_5.0.16/bin/guppy_basecaller  -i  callOnGoing_${uuid}/ \
...
cat guppy_output_${uuid}/pass/*.fastq > guppy_output/fastq_${SLURM_ARRAY_TASK_ID}.fastq
